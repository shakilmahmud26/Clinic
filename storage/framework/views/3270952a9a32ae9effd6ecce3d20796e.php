...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="card">
        <div class="d-flex justify-content-between">
            <h5 class="card-header">Accessions Report</h5>
            ...
            <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                ...
                <div class="table-responsive">
                    <table class="datatables-ajax table table-bordered dataTable no-footer" id="DataTables_Table_0"
                        ...
                        <thead>
                            <tr role="row">
                                <th class="dt-center sorting" tabindex="0" aria-controls="lst_accession" rowspan="1"
                                    colspan="1" aria-label="DATE: activate to sort column ascending"
                                    style="width: 82px;">DATE</th>
                                <th class="dt-center sorting_asc" tabindex="0" aria-controls="lst_accession" rowspan="1"
                                    colspan="1" aria-label="ACCESSIONS NO.: activate to sort column ascending"
                                    style="width: 93px;" aria-sort="ascending">ACCESSIONS NO.</th>
                                <th class="sorting" tabindex="0" aria-controls="lst_accession" rowspan="1" colspan="1"
                                    aria-label="PATIENTS NAME: activate to sort column ascending" style="width: 135px;">
                                    PATIENTS NAME</th>
                                <th class="sorting" tabindex="0" aria-controls="lst_accession" rowspan="1" colspan="1"
                                    aria-label="REFERRING PHYSICIAN: activate to sort column ascending"
                                    style="width: 135px;">REFERRING PHYSICIAN</th>
                                <th class="sorting_disabled" rowspan="1" colspan="1" aria-label="TEST ORDERED"
                                    style="width: 200px;">TEST ORDERED</th>
                                ...
                                <th class="sorting_disabled" rowspan="1" colspan="1" aria-label="SAMPLE ID / TYPE"
                                    style="width: 148px;">SAMPLE ID / TYPE</th>
                            </tr>
                        </thead>
                        <tbody>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\Laravel\Sakil Ahmed\working\resources\views/pages/report/accession.blade.php ENDPATH**/ ?>