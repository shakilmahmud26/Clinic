...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="card">
        <div class="d-flex justify-content-between">
            <h5 class="card-header">Master Draw</h5>
            ...
            <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                ...
                <div class="table-responsive">
                    <table class="datatables-ajax table table-bordered dataTable no-footer" id="DataTables_Table_0"
                        ...
                        <thead>
                            <tr role="row">
                                <th class="dt-center sorting" tabindex="0" aria-controls="lst_master_drawlist"
                                    rowspan="1" colspan="1" aria-label="DATE: activate to sort column ascending"
                                    style="width: 77px;">DATE</th>
                                <th class="dt-center sorting_asc" tabindex="0" aria-controls="lst_master_drawlist"
                                    rowspan="1" colspan="1"
                                    aria-label="ACCESSIONS NO.: activate to sort column ascending" style="width: 84px;"
                                    aria-sort="ascending">ACCESSIONS NO.</th>
                                <th class="sorting" tabindex="0" aria-controls="lst_master_drawlist" rowspan="1"
                                    colspan="1" aria-label="PATIENTS NAME: activate to sort column ascending"
                                    style="width: 99px;">PATIENTS NAME</th>
                                <th class="sorting_disabled" rowspan="1" colspan="1" aria-label="CONFIRMED"
                                    style="width: 83px;">CONFIRMED</th>
                                <th class="sorting" tabindex="0" aria-controls="lst_master_drawlist" rowspan="1"
                                ...
                                <th class="sorting_disabled" rowspan="1" colspan="1" aria-label="SAMPLE ID / TYPE"
                                    style="width: 137px;">SAMPLE ID / TYPE</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr role="row" class="odd">
                                <td class=" dt-center">03/25/2024</td>
                                <td class="dt-center sorting_1"><a href="javascript:;"
                                        onclick="javascript:displayOrder(14050,142122);"
                                        style="cursor: pointer; cursor: hand;" title="View Order Details">142122</a>
                                </td>
                                <td><a href="javascript:;" onclick="javascript:showPatientModal(142122);">BHOGAL, BALBIR
                                        SINGH</a></td>
                                <td>NO</td>
                                <td>INOCENCIO, RUBEN</td>
                                <td>
                                    <ul style="list-style: disc; padding-inline-start: 20px;">
                                        <li>DRUG SCREEN, QUALITATIVE/MULTI</li>
                                        <li>TOTAL PROTEIN, CHOLESTEROL</li>
                                    </ul>
                                </td>
                                <td>
                                    <ul style="list-style: disc; padding-inline-start: 20px;">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\Laravel\Sakil Ahmed\working\resources\views/pages/draw/master.blade.php ENDPATH**/ ?>