                    ...
                    <table class="datatables-ajax table table-bordered dataTable no-footer" id="DataTables_Table_0"
                        ...
                        <tbody>
                            ...
                            <tr role="row" class="odd">
                                ...
                                <td class="sorting_1"><?php echo e($item->run_no); ?></td>
                                <td class="sorting_1"><?php echo e($item->run_date_time); ?></td>
                                <td class=" dt-center"><?php echo e($item->performed_by); ?></td>
        ...
        <div class="modal-dialog modal-dialog-centered1 modal-simple modal-add-new-cc">
            <div class="modal-content p-3 p-md-5">
                <div class="modal-body">
                    ...
                    <form id="addForm" action="<?php echo e(route('qc.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mt-3">
                            ...
                            <div class="col-md-6">
                                <div class="mt-3">
                                    ...
                                    <input type="text" class="form-control" id="run_no" name="run_no"
                                        aria-describedby="defaultFormControlHelp" value="<?php echo e(old('run_no')); ?>"
                                        required />
                                    <?php $__errorArgs = ['run_no'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                            ...
                            <div class="col-md-6">
                                <div class="mt-3">
                                    ...
                                    <input type="datetime-local" class="form-control" id="run_date_time"
                                        ...
                                        value="<?php echo e(old('run_date_time')); ?>" />
                                    <?php $__errorArgs = ['run_date_time'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                            ...
                            <div class="col-md-6">
                                <div class="mt-3">
                                    ...
                                    <input type="text" class="form-control" id="performed_by" name="performed_by"
                                        aria-describedby="defaultFormControlHelp" value="<?php echo e(old('performed_by')); ?>" />
        ...
        <div class="modal-dialog modal-dialog-centered1 modal-simple modal-add-new-cc">
            <div class="modal-content p-3 p-md-5">
                <div class="modal-body">
                    ...
                    <div class="text-center mb-4">
                        <h3>Edit Item</h3>
                        <form id="addForm" action="<?php echo e(route('qc.update')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="mt-3">
                                        ...
                                        <input type="text" class="form-control" id="edit_performed_by"
                                            ...
                                            value="<?php echo e(old('performed_by')); ?>" />
                                        <?php $__errorArgs = ['performed_by'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
        ...
        <div class="modal-dialog modal-dialog-centered1 modal-simple modal-add-new-cc">
            <div class="modal-content p-3 p-md-5">
                <div class="modal-body">
                    ...
                    <form id="deleteForm" action="<?php echo e(route('qc.delete', ['id' => 0])); ?>" method="POST">
                        <?php echo csrf_field(); ?>
    ...
    document.addEventListener('DOMContentLoaded', function() {
            ...
            deleteLinks.forEach(link => {
                link.addEventListener('click', function(e) {
                    ...
                    form.action = '<?php echo e(route('qc.delete', ['id' => ''])); ?>/' + itemId;
                });
            });
        });
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\Laravel\Sakil Ahmed\working\resources\views/pages/report/daily-qc.blade.php ENDPATH**/ ?>