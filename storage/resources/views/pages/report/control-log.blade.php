                    ...
                    <table class="datatables-ajax table table-bordered dataTable no-footer" id="DataTables_Table_0"
                        ...
                        <tbody>
                            ...
                            <tr role="row" class="odd">
                                ...
                                <td class="sorting_1">{{$item->instrument}}</td>
                                ...
                                <td class=" dt-center">{{$item->level}}</td>
                                <td class=" dt-right">{{$item->range_from}}</td>
                                <td class=" dt-right">{{$item->range_to}}</td>
                                <td class=" dt-right">{{$item->qc_range}}</td>
                                <td class=" dt-right">{{$item->standard_deviation}}</td>
                                <td class=" dt-center">
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#editItemModal" class="edit-icon"
                                        data-item-id="{{ $item->id }}" style="margin-right: 15px;">
                                        <i class="fa-solid fa-pen"></i>
        ...
        <div class="modal-dialog modal-dialog-centered1 modal-simple modal-add-new-cc">
            <div class="modal-content p-3 p-md-5">
                <div class="modal-body">
                    ...
                    <form id="addForm" action="{{route('log.control.store')}}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mt-3">
                            ...
                            <div class="col-md-12">
                                <div class="mt-3">
                                    ...
                                    <input type="text" class="form-control" id="average_mean" name="average_mean"
                                        aria-describedby="defaultFormControlHelp" value="{{ old('average_mean') }}" />
                                    @error('average_mean')
                                    <div class="form-text text-danger">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="mt-3">
                                    ...
                                    <input type="text" class="form-control" id="range_from" name="range_from"
                                        aria-describedby="defaultFormControlHelp" value="{{ old('range_from') }}" />
                                    @error('range_from')
                                    <div class="form-text text-danger">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="mt-3">
                                    ...
                                    <input type="text" class="form-control" id="range_to" name="range_to"
                                        aria-describedby="defaultFormControlHelp" value="{{ old('range_to') }}" />
                                    @error('range_to')
                                    <div class="form-text text-danger">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="mt-3">
                                    ...
                                    <input type="text" class="form-control" id="qc_range" name="qc_range"
                                        aria-describedby="defaultFormControlHelp" value="{{ old('qc_range') }}" />
                                    @error('qc_range')
                                    <div class="form-text text-danger">
                                        {{ $message }}
                                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered1 modal-simple modal-add-new-cc">
            <div class="modal-content p-3 p-md-5">
                <div class="modal-body">
                    ...
                    <div class="text-center mb-4">
                        <h3>Edit Item</h3>
                        <form id="addForm" action="{{route('log.control.update')}}" method="POST">
                            @csrf
                                ...
                                <div class="col-md-12">
                                    <div class="mt-3">
                                        ...
                                        <input type="text" class="form-control" id="edit_average_mean"
                                            ...
                                            value="{{ old('edit_average_mean') }}" />
                                        @error('edit_average_mean')
                                        <div class="form-text text-danger">
                                            {{ $message }}
                                        </div>
                                        @enderror
        ...
        <div class="modal-dialog modal-dialog-centered1 modal-simple modal-add-new-cc">
            <div class="modal-content p-3 p-md-5">
                <div class="modal-body">
                    ...
                    <form id="deleteForm" action="{{ route('log.control.delete', ['id' => 0]) }}" method="POST">
                        @csrf
    ...
    document.addEventListener('DOMContentLoaded', function() {
            ...
            deleteLinks.forEach(link => {
                link.addEventListener('click', function(e) {
                    ...
                    form.action = '{{ route('log.control.delete', ['id' => '']) }}/' + itemId;
                });
            });
        });
